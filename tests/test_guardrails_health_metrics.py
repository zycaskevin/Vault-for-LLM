...
from vault.guardrails_health import collect_guardrails_health_metrics
...
class _FakeTableQuery:
    ...
    def _assert_health_does_not_reference_id(self, fields):
        ...
        for field in fields:
            if field == "id":
                raise AssertionError("agent-runtime_guardrails_health fake schema has no id column")
