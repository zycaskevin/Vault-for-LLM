...
| `vault automation report` / `vault automation eval` / `vault automation doctor` | Review automation reports, evaluate candidate-outcome feedback, and check scheduled-job readiness |
