...
```text
Install Vault-for-LLM for this project. Use vault-for-llm[mcp]==0.7.0rc1.
...
pip install "vault-for-llm[mcp]==0.7.0rc1"
...
```bash
pip install "vault-for-llm[supabase]==0.7.0rc1"
