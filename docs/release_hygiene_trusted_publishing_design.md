...
> **For agent runtime:** Use `subagent-driven-development` if this design is implemented as code. Keep release changes bite-sized and commit after each verified segment.
