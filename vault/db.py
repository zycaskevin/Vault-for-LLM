...
class VaultDB:
    ...
    def _init_tables(self):
        ...
        # Task Ledger keeps active task state separate from L0-L3 long-term memory.
        c.execute("""
        ...
        """)
        c.execute("CREATE INDEX IF NOT EXISTS idx_task_ledger_status ON task_ledger(status)")
        c.execute("CREATE INDEX IF NOT EXISTS idx_task_ledger_updated_at ON task_ledger(updated_at)")
        c.execute("CREATE INDEX IF NOT EXISTS idx_task_ledger_scope ON task_ledger(scope)")
        c.execute("CREATE INDEX IF NOT EXISTS idx_task_ledger_sensitivity ON task_ledger(sensitivity)")
        c.execute("CREATE INDEX IF NOT EXISTS idx_task_ledger_owner_agent ON task_ledger(owner_agent)")
        ...
        """)
        c.execute("CREATE INDEX IF NOT EXISTS idx_task_events_task_id ON task_events(task_id)")
        c.execute("CREATE INDEX IF NOT EXISTS idx_task_events_created_at ON task_events(created_at)")
        c.execute("CREATE INDEX IF NOT EXISTS idx_task_events_type ON task_events(event_type)")
        ...
        """)
        c.execute("CREATE INDEX IF NOT EXISTS idx_task_evidence_task_id ON task_evidence_refs(task_id)")
        c.execute("CREATE INDEX IF NOT EXISTS idx_task_evidence_ref_type ON task_evidence_refs(ref_type)")
