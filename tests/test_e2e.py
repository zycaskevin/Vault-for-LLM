...
compiler = GuardrailsCompiler(project_dir="/home/user/Guardrails-knowledge", db=db, embed_provider=embed_prov)
try:
...
CLI = "/home/user/miniconda3/envs/guardrails-lite/bin/guardrails"
...
for cmd, desc in commands:
    try:
        r = subprocess.run(
            ...
            timeout=30, cwd="/home/user/Guardrails-knowledge"
        )
        ok = r.returncode == 0
