    ...
    readme_path.write_text(
        "\n".join(
            [
                ...
                "   - Treat local `vault.db` as the source of truth and Supabase as a read-only copy unless a future status says otherwise.",
    ...
    startup_sequence = [
        ...
        },
        {
            ...
            "result_contract": {
                ...
                "remote_model": "supabase_readonly_copy",
    ...
    runtime_playbook_readme_path.write_text(
        "\n".join(
            [
                ...
                "   This is offline: it confirms local `vault.db` is the source of truth and Supabase is a read-only copy unless a future status says otherwise.",
